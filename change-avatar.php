...
include 'head.php';
echo '<div class="phdr"><a href="/account" style="color:#131CF1;">Tài Khoản</a> ><a style="color:#71BBCE;"> Thay Đổi Ảnh Đại Diện</a></div>';
if (login){
...
<div class="list"><form action="" method="post" enctype="multipart/form-data">Chọn ảnh: '.$erup.'<br>
<input type="file" name="imup"><br><input type="checkbox" name="del">Xóa ảnh đại diện<br><br>
<input type="submit" name="change" value="Thay Đổi" style="color:white; background-color: #71BBCE; border-radius: 8px;"></form></div></div></div>';
} else {
